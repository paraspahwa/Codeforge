...
const COPY = {
  en: {
    ...
    composerHint: "Enter to send · Shift+Enter for new line · 📎 attach PDF, images, Markdown",
  ...
  hinglish: {
    ...
    composerHint: "Enter bhejo · Shift+Enter nayi line · 📎 PDF, images attach kar sakte ho",
